...
- (void)xb_setGifWithName:(NSString *)name
{
    NSURL * url = [[NSURL alloc]initFileURLWithPath:[[NSBundle mainBundle] pathForResource:name ofType:nil]];
    [self yh_setImage:url];
}
@end
